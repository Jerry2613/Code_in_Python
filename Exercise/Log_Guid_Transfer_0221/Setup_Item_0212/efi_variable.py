...
class EfiVariable:
    ...
    def __init__(self, cwd_setup_item_folder, project_folder, platform_folder, output_folder, token_dict,
        ...
        self.used_runtime_variable = used_runtime_variable
        self.bios_default_filename = 'Defaults.bin'
        self.setup_variable_define_filename = 'HardcodedSetupData.h'
        self.setup_variable_default_file = self.output_folder + '\media\setup_default.bin'
        self.bootmanager_file = cwd_setup_item_folder + '\external_files\BootManager.bin'
        self.setupamtfeatures_file = cwd_setup_item_folder + '\external_files\SetupAmtFeatures.bin'
        if self.used_runtime_variable:
            self.setup_file = cwd_setup_item_folder + '\external_files\setup.bin'
        else:
...
if __name__ == '__main__':
    ...
    cwd_setup_item_folder = os.getcwd()
    output_folder = cwd_setup_item_folder

    token_dict = {}
    efi_variable = EfiVariable(cwd_setup_item_folder, p_folder, platform_folder, output_folder, token_dict,
