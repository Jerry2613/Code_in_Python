...
class EfiVariable:
    ...
    def buildup_other_variable_dict(self):
        ...
        if self.setupamtfeatures_file != 'None':
...
if __name__ == '__main__':
    ...
    external_files_folder = cwd_setup_item_folder + '\external_files'

    token_dict = {}
    efi_variable = EfiVariable(external_files_folder, p_folder, platform_folder, output_folder, token_dict,
