...
class GuidAction(object):
    ...
    def transfer_logfile_guid(self):
        with open(self.target_log_file, "r", encoding='mbcs') as Old_log, open(self.output_log_file, "w", encoding='mbcs') as New_log:
...
if __name__ == '__main__':
    ...
    with open(p.output_log_file, "r", encoding='mbcs') as logfile, open('loading_sequence.txt', "w", encoding='mbcs') as loading:
        for line in logfile:
